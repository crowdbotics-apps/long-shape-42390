"""
Django settings for long_shape_42390 project.
...
ROOT_URLCONF = 'long_shape_42390.urls'
...
WSGI_APPLICATION = 'long_shape_42390.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "long_shape_42390 API",
    "DESCRIPTION": "API documentation for long_shape_42390 App",
    "VERSION": "v1",
}
